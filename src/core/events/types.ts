...
export type GameEvent =
    ...
    | {
          type: 'MUTINY_STARTED';
          playerId: string;
          reason?: 'flog' | 'critical_damage' | 'arena_laser';
      }
    | {
    ...
    | { type: 'ATTACK_DECLARED'; attackerId: string; targetId: string | null }
    | { type: 'BOARDER_DEFEATED'; playerId: string }
    | {
